...
namespace IW3SR
{
	...
	{
		sr_version = RegisterString("sr_version", DvarFlags(DVAR_READONLY | DVAR_SERVERINFO), "Client version",
			CMAKE_PROJECT_VERSION);
		pm_mode = RegisterInt("pm_mode", DvarFlags(DVAR_READONLY | DVAR_SERVERINFO), "Movement mode.", 0, 0, 2);
	}
